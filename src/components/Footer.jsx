    ...
    <div>
      ...
      >
        ...
        <div className="text-center w-full pt-5 px-2">
          ...
          <button
            ...
            style={{
              ...
              borderRadius: '8px',
              backgroundImage:
                'linear-gradient(black, black), linear-gradient(90deg, #FFDF41, #FF8800)',
        ...
        <div className="p-md-5">
          <h1
            className="slogen text-center  text-5xl"
            style={{ fontWeight: '600', color: '#ffc100' }}
          >
        ...
        <div className="container text-center ">
          <h1
            className="slogen text-5xl mb-5"
            style={{ fontWeight: '600', color: '#ffc100' }}
          >
            Want To Learn More
          </h1>
          ...
          >
            ...
            <ul className="list-unstyled font-medium text-xl">
              <li className="mb-2">
                <a
                  href="/about"
                  className="text-dark text-decoration-none text-lg"
                >
                  About
                </a>
              </li>
          ...
          <Col md={6} lg={3} sm={12}>
            <div style={{ width: 'max-content' }} className="m-auto">
              ...
              <div className="d-flex my-4 text-xl">
                ...
                <span className="ms-3 font-semibold">TrackPi@gmail.com</span>
              </div>
            </div>
          </Col>
        </Row>
      ...
      <hr className="m-0" />
      <Row>
        <Col className="text-center font-medium text-sm mb-3">
