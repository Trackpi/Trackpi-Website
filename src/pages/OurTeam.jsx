    ...
    <>
      <section className="flex justify-center items-center  h-full w-full px-4 py-8">
        <div className="  flex flex-col items-center">
          <h1 className="text-5xl md:text-6xl lg:text-7xl text-amber-500  hiring_heading">
            Who We Are?
          </h1>
        </div>
      </section>
      <section
        ref={refFirstSection}
        className="mt-20 w-full px-6 lg:px-20 xl:px-24 2xl:px-32 mx-auto section1"
      >
        <motion.div
        ...
        >
          <div className="md:w-1/2">
            <motion.h1
              className="fw-bold text-[#FFC100] text-3xl xl:text-5xl 2xl:text-6xl pb-3"
              initial={{ opacity: 0, x: -50 }}
              animate={inViewFirstSection ? { opacity: 1, x: 0 } : {}}
              transition={{ duration: 0.8 }}
            >
      ...
      <section className="mt-20 flex flex-col items-center gap-10 w-full h-full">
        <div className="flex flex-col items-center ">
          ...
          <h5 className="text-bold text-black text-sm sm:text-lg md:text-2xl xl:text-xl xl-leading-7 2xl:leading-10 2xl:text-3xl ">
      ...
      <section
        ref={refThirdSection}
        className="px-6 lg:px-20 xl:px-24 2xl:px-32 mx-auto w-full h-full mt-28 section3"
      >
        <motion.div
          className="flex flex-col md:flex-row gap-12 lg:gap-20 xl:gap-20 2xl:gap-32 items-center"
          initial={{ opacity: 0, x: -50 }}
        ...
        >
          <div className="flex flex-col w-full md:w-1/2">
            <motion.h1
              className="fw-bold text-yellow-500 text-3xl lg:text-5xl xl:text-5xl 2xl:text-6xl"
              initial={{ opacity: 0, x: -50 }}
              animate={inViewThirdSection ? { opacity: 1, x: 0 } : {}}
              transition={{ duration: 0.8 }}
            >
