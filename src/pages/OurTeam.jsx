          ...
          <Row>
            <Col md={6} className="flex flex-col items-center pt-12">
              ...
              <p className="text-xl text-justify md:text-lg">
                We’re here to change how the world works—from business as usual
                to brave new work. It takes an unusual person to disrupt decades
                of tradition and guide hundreds or thousands of people through
                an experience that demands their bravery, vulnerability, and
                curiosity. It takes conviction to join a decentralized,
                self-managing, public benefit corporation where reputation
          ...
          <Row>
            ...
            <Col md={6} className="flex flex-col items-center pt-12">
              ...
              <p className="text-justify text-xl md:text-lg">
                ...
                technologists, and corporate veterans who have found each other
                in our quest to make work better. Our backgrounds are varied but
                our ambition is united.
              </p>
            </Col>
          </Row>
        </Container>
        ...
        <Container>
          <Row>
            <Col md={6} className="flex flex-col items-center pt-12">
              ...
              <p className="text-xl md:text-justify md:text-lg">
                The Ready’s hiring team reviews all applications anonymously and
