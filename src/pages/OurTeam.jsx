...
<section ref={refFirstSection} className="mt-20 w-full px-6 lg:px-20 xl:px-24 2xl:px-32 mx-auto section1">
        <motion.div
...
<section  className="mt-20 flex flex-col items-center gap-10 w-full h-full">
       <div className="flex flex-col items-center ">
 ...
 <section  ref={refSecondSection} className="mt-28 w-full px-6 lg:px-20 xl:px-24 2xl:px-32 mx-auto py-20 bg-gradient-to-r from-[#FF9D00] via-[#FFC100] to-[#FF9D00] text-black bgg11 section2">
        <motion.div
          className="flex flex-col md:flex-row gap-12 lg:gap-20 xl:gap-20 2xl:gap-32 items-center"
          initial={{ opacity: 0, x: -50 }}
...
<section ref={refThirdSection} className="px-6 lg:px-20 xl:px-24 2xl:px-32 mx-auto w-full h-full mt-28 section3">
        <motion.div
          className="flex flex-col md:flex-row gap-12 lg:gap-20 xl:gap-20 2xl:gap-32 items-center"
          initial={{ opacity: 0, x: -50 }}
        ...
        >
          <div className="flex flex-col w-full md:w-1/2">
            <motion.h1
              className="font-bold text-yellow-500 text-5xl 2xl:text-7xl"
              initial={{ opacity: 0, x: -50 }}
              animate={inViewThirdSection ? { opacity: 1, x: 0 } : {}}
              transition={{ duration: 0.8 }}
            >
            ...
            >
              The Trackpi's hiring team reviews all applications anonymously
                  ...
                  <br/>
                  <Button
                className=" mt-4 bg-transparent  text-black font-bold  rounded-pill  hover:bg-gray-800 
