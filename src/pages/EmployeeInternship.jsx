    ...
    <div className="pad mt-20 w-full py-10 px-6 lg:px-20 xl:px-24 2xl:px-32 mx-auto ">
       ...
       <div className=" grid grid-cols-1 md:grid-cols-2 gap-12 sm:text-lg md:text-2xl xl:text-xl xl:leading-7 2xl:leading-7 2xl:text-2xl mt-20 ">
                  <div>
                    ...
                    <br/>
                    <ul className="list-disc text-justify text-xl sm:text-lg md:text-xl xl:text-xl xl:leading-7 2xl:leading-7 2xl:text-xl leading-7  font-medium space-y-2.5">
                ...
                <div className=" ">
                        <div
                            className=" custom-height w-full h-[300px] md:h-[350px] xl:h-[400px] flex justify-center items-center rounded-t-md"
