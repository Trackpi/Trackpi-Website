...
function App() {
  ...
  const showHeaderFooter = ["/", "/about", "/our-services", "/connect-us", "/employee-verification", "/new-project-form", "/employeesales", "/employeeinternship"].includes(location.pathname);
  const isAdminRoute = location.pathname.startsWith("/admin");
  const isAdminRouted = location.pathname.startsWith("/admin");
